                        ...
                        <div className="pr-4 w-1/2">
                          ...
                          <div className="mt-2.5">
                            <input
                              ...
                              id="LpgNo"
                              value={
                                data ? data.approvedConnection[0].lpgNo : ""
                              }
                        ...
                        <div className="pr-4 w-1/2">
                          ...
                          <div className="mt-2.5">
                            <input
                              ...
                              id="FirstName"
                              value={
                                data ? data.approvedConnection[0].firstName : ""
                              }
                              className="w-full border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                              disabled
                            />
                        ...
                        <div className="pr-4 w-1/2">
                          ...
                          <div className="mt-2.5">
                            <input
                              ...
                              id="LastName"
                              value={
                                data ? data.approvedConnection[0].lastName : ""
                              }
                              className="w-full border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                              disabled
                            />
                        ...
                        <div className="pr-4 w-1/2">
                          ...
                          <div className="mt-2.5">
                            <input
                              ...
                              value={
                                data
                                  ? data.approvedConnection[0].rationCardNumber
                                  : ""
                              }
                              className="w-full border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                              disabled
                      ...
                      <div>
                        ...
                        <div className="mt-2.5">
                          <textarea
                            ...
                            disabled
                            value={
                              data ? data.approvedConnection[0].address : ""
                            }
                            className="w-full border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                          ></textarea>
                        </div>
                        ...
                        <div className="pr-4 w-1/2">
                          ...
                          <div className="mt-2.5">
                            <input
                              ...
                              value={
                                data
                                  ? data.approvedConnection[0].aadharCardNumber
                                  : ""
                              }
                              className="w-full border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                              disabled
                        ...
                        <div className="pr-4 w-1/2">
                          ...
                          <div className="mt-2.5">
                            <input
                              ...
                              id="POAName"
                              value={
                                data ? data.approvedConnection[0].poaName : ""
                              }
                              className="w-full border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                              disabled
                            />
                        ...
                        <div className="pr-4 w-1/2">
                          ...
                          <div className="mt-2.5">
                            <input
                              ...
                              id="POANo"
                              value={
                                data ? data.approvedConnection[0].poaNo : ""
                              }
                              className="w-full border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                              disabled
                            />
                        ...
                        <div className="pr-4 w-1/2">
                          ...
                          <div className="mt-2.5">
                            <input
                              ...
                              id="POIName"
                              value={
                                data ? data.approvedConnection[0].poiName : ""
                              }
                              className="w-full border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                              disabled
                            />
                        ...
                        <div className="pr-4 w-1/2">
                          ...
                          <div className="mt-2.5">
                            <input
                              ...
                              id="POINo"
                              value={
                                data ? data.approvedConnection[0].poiNo : ""
                              }
                              className="w-full border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                              disabled
                            />
                        ...
                        <div className="pr-4 w-1/2">
                          ...
                          <div className="mt-2.5">
                            <input
                              ...
                              value={
                                data
                                  ? data.approvedConnection[0].product
                                      .productName +
                                    "-" +
                                    data.approvedConnection[0].product.brand
                                      .brandName
                                  : ""
                              }
                              disabled
                        ...
                        <div className="pr-4 w-1/2">
                          ...
                          <div className="mt-2.5">
                            <input
                              ...
                              id="EmailId"
                              value={
                                data ? data.approvedConnection[0].emailId : ""
                              }
                              className="w-full border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                              disabled
                            />
                        ...
                        <div className="pr-4 w-1/2">
                          ...
                          <div className="mt-2.5">
                            <input
                              ...
                              value={
                                data
                                  ? data.approvedConnection[0].phoneNumber
                                  : ""
                              }
                              className="w-full border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                              disabled
