...
const ViewSupplier = () => {
  ...
  const { brands, totalCount, page, pageSize } = useSelector(
  ...
  const fetchData = useCallback(
    debounce((page, pageSize,search) => {
      dispatch(fetchBrands({ page, pageSize ,search}));
    }, 1500),
    [dispatch]
  );
                ...
                <table className="w-full border border-gray-300">
                  <thead className="bg-white">
                    <tr>
                      ...
                      <th className="p-3 border border-b border-gray-300 text-gray-700">Supplier Name</th>
                      <th className="p-3 border border-b border-gray-300 text-gray-700">Status</th>
